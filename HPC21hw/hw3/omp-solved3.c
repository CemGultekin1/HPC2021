...
/*
Cem's Note:
OpenMP reconizing i,j variables within function space
as the variables declared outside causes the threads to lock 

Changing variable names solves the problem
 */
#include <omp.h>
#include <stdio.h>
#include <stdlib.h>
